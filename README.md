...
In meinem Snake Spiel kann man Snake spielen. Man kann die weisse Schlange über die Tasten WASD steuern.

Sobald die Schlange eine rote Frucht frisst erhöht dich der Highscore um eins und die Schlange wird eins länger.
...
- Ich erstelle einen Vokabeltrainer mit JavaScript
...
- [x] Als Spieler möchte ich das eine neue Frucht erscheint und der Highscore, um eins steigt, wenn ich eine Frucht einsammle, damit ich weiss wohin ich mich bewegen muss. (Wenn Kopf der Schlange == Position der Frucht)

- [x] Als Spieler möchte ich das die Schlange ein Pixel länger wird, wenn ich eine Frucht einsammle, damit das Spiel immer schwieriger wird. (Zweite Schlange stoppt für einen Pixel)

Heute habe ich meine Schlange Früchte fressen lasse. Nachdem man nun in eine Frucht hineingefahren ist erscheint eine neue Frucht und der Highscore, den man oben rechts sehen kann, wird um eins erhöht. Sobald man nun eine Frucht einsammelt hält die zweite Schlange für einen kurzen Moment an, damit es so aussieht, als werde die erste Schlange ein Feld länger. Zum Schluss habe ich noch das Farbkonzept angepasst. (68 Wörter)

## Reflexion

In dieser Lernperiode wollte ich zuerst einen Vokabeltrainer implementieren, nachdem ich schnell keine Ideen mehr hatte, habe ich mich an ein Snake Spiel herangewagt. Zuerst habe ich mit Canvas das Brett für die Schlange erstellt. Danach habe ich Tastatureingaben eingelesen und einen gameloop implementiert.

Nach einer Phase krank und dem daraus resultierendem Verzug bei den Aufträgen und der Lernbeurteilung in M294 habe ich mit dem Advent of Code 2024 gestartet.

Zum Schluss dieser Lerperiode hatte ich wieder Zeit für mein Snake Spiel. Ich konnte einige Fehler beheben, das Einsammeln der Frucht und das Verlängern der Schlange implementieren. Nun ist mein Spiel einsatzbereit. (102 Wörter)

## Mögliche Erweiterungen

- [ ] Als Spieler möchte ich, dass die Schlange stirbt, wenn sie in sich selbst hineinfährt.
